{{-- ========================================
    FILE: resources/views/partials/buy-template.blade.php
    DESCRIPTION: Buy template floating button
======================================== --}}
<div class="fixed bottom-0 right-0 m-4 z-50">
   <a href="https://codescandy.lemonsqueezy.com/buy/7b77d92f-acf6-4fdc-885b-00fa9a0786e4" 
      target="_blank"
