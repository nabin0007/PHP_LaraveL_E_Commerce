        ...
        <div class="block w-full overflow-x-auto scrolling-touch pb-6">
            <div class="xl:grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="flex-0 block w-full md:w-auto">
                    <div class="pt-8 px-6 rounded-lg" style="background-image: url('/assets/images/banner/banner-deal.jpg'); background-size: cover; height: 480px">
                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="text-center relative flex justify-center">
                                ...
                                <div class="absolute w-full bottom-[15%] opacity-0 invisible hover:opacity-100 hover:visible transition-opacity duration-300">
