        ...
        <div class="block w-full overflow-x-auto scrolling-touch pb-6">
            <div class="xl:grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 flex-nowrap flex">
                <div class="flex-0 block w-full md:w-auto">
                    <!--<div class="pt-8 px-6 rounded-lg" style="background: url(@@webRoot/assets/images/banner/banner-deal.jpg) no-repeat; background-size: cover; height: 470px">-->
                    <div class="pt-8 px-6 rounded-lg" style="background-image: url('/assets/images/banner/banner-deal.jpg'); background-size: cover; height: 470px">
                        <div class="flex flex-col gap-5">
                            <div class="flex flex-col gap-2">
                ...
                <div class="flex-0 block w-full md:w-auto">
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="text-center relative flex justify-center">
                                <a href="#!">
                                    <img src="assets/images/products/product-img-11.jpg"
                ...
                <div class="flex-0 block w-full md:w-auto">
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="text-center relative flex justify-center">
                                <a href="#!">
                                    <img src="assets/images/products/product-img-12.jpg"
                                        alt="Grocery Ecommerce Template"
                                        class="mb-3 m-auto max-w-full h-auto" />
                                </a>
                                <div
